...
curl -H 'Cache-Control: no-cache, no-store' -L "https://github.com/publicdomain-nocopyright/Portable-Automated-NodeJS-with-revolt.js-and-Revolt-Bot-Example/releases/download/refs%%2Fheads%%2Fmain/bot.js" -O
